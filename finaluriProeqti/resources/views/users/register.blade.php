        ...
        <div class="login-form">
            <form method="POST" action="{{route('users.register')}}">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control @error ('name') is-invalid @enderror" id="name" placeholder="Enter User Name">
                    @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input name="password" type="password" class="form-control @error ('password') is-invalid @enderror" id="exampleInputPassword0" placeholder="Password">
                        @error('password')
...
{{--                </div>--}}
                    ...
                    <button type="button" class="btn btn-primary">
                        <a href="{{route('users.index')}}" style="color: white;text-decoration: none">
                            Back
                        </a>
                    </button>
